...
router.get("/allocation-orders-own",warehouseController.getAllocationOrdersOwn)
router.get("/asset-stock/:asset_id", warehouseController.getAssetStockAcrossWarehouses)
// create warehouse
