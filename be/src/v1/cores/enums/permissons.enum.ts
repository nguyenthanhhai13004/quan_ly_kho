export enum PermissionsEnum {
  ...
  COMMANDER_STUDENTS_VIEW = "COMMANDER_STUDENTS_VIEW",
  COMMANDER_REQUESTS_MANAGE = "COMMANDER_REQUESTS_MANAGE",
  WAREHOUSE_OFFICER_REQUESTS_VIEW = "WAREHOUSE_OFFICER_REQUESTS_VIEW",
  WAREHOUSE_OFFICER_REQUESTS_APPROVE = "WAREHOUSE_OFFICER_REQUESTS_APPROVE",
}
