...
studentRouter.post("/", grantAccessAny([PermissionsEnum.MANAGE_USER, PermissionsEnum.COMMANDER_STUDENTS_VIEW]), asyncHandler(StudentController.createStudent));
...
studentRouter.delete("/:id", grantAccessAny([PermissionsEnum.MANAGE_USER, PermissionsEnum.COMMANDER_STUDENTS_VIEW]), asyncHandler(StudentController.delete));
